...
const benefits = [
  ...
  },
  {
    icon: TrendingUp,
    title: "Career Growth",
    desc: "Clear career progression paths and skill development",
  },
  {
    icon: Coffee,
  ...
  },
  {
    ...
    desc: "Cutting-edge projects and latest technologies",
  },
  {
    icon: Shield,
    title: "Job Security",
        ...
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-16">
            {companyStats.map((stat, idx) => (
              <div
                key={idx}
                className="text-center p-6 bg-white/5 rounded-2xl border border-white/10 backdrop-blur-sm hover:bg-white/10 transition-all duration-300"
              >
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              ...
              innovation, and making a meaningful impact.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {benefits.map((benefit, idx) => (
              <div
                key={idx}
                className="group p-8 bg-gradient-to-br from-slate-900/80 to-blue-900/20 rounded-2xl border border-blue-500/20 hover:border-blue-400/50 transition-all duration-300 hover:transform hover:scale-105"
              >
      ...
      <section className="py-20 px-6 bg-gradient-to-r from-slate-900/50 to-blue-900/30">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="relative">
            <div className="flex items-center justify-between mb-8">
              ...
              <div className="text-center">
                <span className="text-gray-400">
                  {jobIndex + 1}-
                  {Math.min(jobIndex + jobsPerView, jobOpenings.length)} of{" "}
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {jobOpenings
                .slice(jobIndex, jobIndex + jobsPerView)
                .map((job) => (
                  <div
                    key={job.id}
                    className="group bg-gradient-to-br from-slate-900/90 to-blue-900/30 rounded-2xl border border-blue-500/20 hover:border-blue-400/50 transition-all duration-300 overflow-hidden hover:shadow-2xl"
                  >
                    <div className="p-6">
      ...
      <section className="py-20 px-6 bg-gradient-to-r from-blue-900/30 to-slate-900/50">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300">
              A transparent and fair process designed to identify the best
              talent
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Initial screening of applications and resumes",
              },
              {
                step: 2,
                title: "Technical Assessment",
                desc: "Evaluate technical skills and problem-solving abilities",
              },
              {
                step: 3,
                title: "Interview Rounds",
                desc: "Technical and behavioral interviews with team leads",
              },
              {
                step: 4,
                title: "Final Selection",
                desc: "Reference checks and final decision making",
              },
            ].map((process, idx) => (
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-300 mb-6 leading-relaxed">
                At Dharvix Tech Solutions, you'll be working with some of the
                most talented and dedicated professionals in the industry. Our
                performance-oriented culture embodies excellence at every level.
              </p>
            ...
            <div className="space-y-6">
              <div className="p-6 bg-gradient-to-br from-slate-900/80 to-green-900/20 rounded-2xl border border-green-500/20">
                ...
                <p className="text-gray-300 text-sm">
                  Regular health check-ups, yoga and meditation classes, and
                  fitness programs to keep our team healthy and motivated.
                </p>
              </div>
              ...
              <div className="p-6 bg-gradient-to-br from-slate-900/80 to-blue-900/20 rounded-2xl border border-blue-500/20">
                ...
                <p className="text-gray-300 text-sm">
                  Challenging projects with esteemed clients that provide new
                  skills, knowledge, and expertise every day.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-start p-8 bg-gradient-to-br from-slate-900/90 to-yellow-900/20 rounded-2xl border border-yellow-500/30">
            ...
            <div>
              ...
              <p className="text-gray-300 mb-4 leading-relaxed">
                We've noticed fraudulent activities by some agents/agencies
                misleading candidates about fake job offers from Dharvix Tech
                Solutions. Please verify any communication directly with us.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <a
                  href="mailto:hr@dharvixtechsolutions.com"
                  className="flex items-center text-blue-400 hover:text-blue-300 font-medium"
                >
      ...
      <section className="py-20 px-6 bg-gradient-to-r from-blue-900/40 to-purple-900/40">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Take the next step in your career journey. We're always looking for
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-12">
            ...
            <div className="p-6 bg-white/5 rounded-2xl border border-white/10">
              ...
              <p className="text-gray-300 text-sm">
                Fair hiring for all candidates
              </p>
            </div>
          </div>
        </div>
