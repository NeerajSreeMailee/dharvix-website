...
// Define the Item interface to match newsEvents
interface Item {
  id: number;
  image: string;
  title: string;
  date: string;
  category: 'Events' | 'Awards' | 'CSR' | 'Partnership' | 'Company Culture' | 'Financial';
  location: string;
  desc: string;
  featured: boolean;
  readTime: string;
...
// Type categoryIcons using Record
const categoryIcons: Record<Item['category'], React.ElementType> = {
  Events: Calendar,
  Awards: Award,
  CSR: Users,
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-center px-6 md:px-12 lg:px-20 py-12 text-white max-w-4xl">
          <div className="animate-in slide-in-from-left duration-700">
            ...
            <p className="text-lg md:text-xl lg:text-2xl leading-relaxed max-w-2xl mb-8 text-blue-100">
              Stay connected with the latest innovations, achievements, and
              milestones that define our journey at Dharvix Tech Solutions.
            </p>
          ...
          >
            <div>
              ...
              <p className="text-purple-200 text-sm">
                Conferences, workshops, and company events
              </p>
            </div>
      ...
      <section className="w-full max-w-7xl mx-auto px-6 mb-16">
        <div className="mb-12">
          ...
          <p className="text-blue-200 text-lg">
            Our most significant achievements and events
          </p>
        </div>
              ...
              >
                <div className="relative w-full h-[200px] overflow-hidden">
                  ...
                  <div className="absolute top-3 right-3">
                    <span className="bg-black/50 text-white px-2 py-1 rounded text-xs backdrop-blur-sm flex items-center gap-1">
      ...
      <section className="w-full bg-gradient-to-r from-blue-900/50 to-purple-900/50 py-16">
        <div className="max-w-4xl mx-auto text-center px-6">
          ...
          <p className="text-blue-200 text-lg mb-8 max-w-2xl mx-auto">
            ...
            invitations, and exclusive insights directly in your inbox.
          </p>
