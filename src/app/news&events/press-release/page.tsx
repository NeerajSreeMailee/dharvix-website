...
import { Calendar, Users, Award, Briefcase, MapPin, Clock, ArrowRight, Filter, Eye, Share2, Bookmark } from "lucide-react";
...
const newsArticles = [
	...
	},
	{
		...
		fullContent: "This partnership enables us to leverage Microsoft's robust cloud infrastructure to provide our clients with scalable, secure, and cost-effective solutions. Our certified Azure specialists will work closely with businesses to migrate their operations to the cloud seamlessly.",
		featured: true,
		readTime: "4 min read",
		views: 980,
		author: "CEO Office"
	},
	{
		...
		fullContent: "Our strong financial performance reflects the trust our clients place in our innovative solutions. The growth was primarily driven by increased demand for our IoT and AI services, with notable expansion in the healthcare and manufacturing sectors.",
		featured: false,
		readTime: "6 min read",
		views: 750,
	...
	},
	{
		...
		fullContent: "The new research facility will house 50+ researchers and engineers working on next-generation AI solutions. The lab will collaborate with local universities and contribute to making Visakhapatnam a leading tech hub in Andhra Pradesh.",
		featured: false,
		readTime: "3 min read",
		views: 620,
		author: "R&D Team"
	},
	{
		...
		fullContent: "The feature article discusses our role in promoting sustainable technology practices and how we're helping businesses reduce their carbon footprint through smart automation solutions.",
		featured: false,
		readTime: "4 min read",
		views: 890,
	...
	},
	{
		...
		fullContent: "The program includes monthly awards, annual recognition ceremonies, and performance-based incentives. We believe in recognizing and rewarding the talented individuals who drive our success.",
		featured: false,
		readTime: "2 min read",
		views: 540,
...
const newsCategories = ["All", "Awards", "Partnership", "Financial", "Company News", "Media Coverage", "Company Culture"];
		...
		<div className="flex flex-col min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-slate-950">
				...
				<div className="relative z-10 flex-1 flex flex-col justify-center px-6 md:px-12 lg:px-20 py-12 text-white max-w-4xl">
					<div className="animate-in slide-in-from-left duration-700">
						...
						<p className="text-lg md:text-xl lg:text-2xl leading-relaxed max-w-2xl mb-8 text-blue-100">
							Stay informed about our latest achievements, partnerships, financial milestones, 
							and company developments that shape our future.
						</p>
			...
			<section className="w-full max-w-7xl mx-auto px-6 mb-16">
				<div className="mb-12">
					...
					<p className="text-blue-200 text-lg">Our most significant company announcements and achievements</p>
				</div>
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
					{featuredNews.map((article, idx) => {
						const IconComponent = categoryIcons[article.category] || Users;
						return (
							<article
								key={article.id}
			...
			<section className="w-full max-w-7xl mx-auto px-6 pb-16">
				...
				{filteredNews.length === 0 && (
					<div className="text-center py-16">
						...
						<h3 className="text-xl font-semibold text-blue-200 mb-2">No news articles found</h3>
			...
			<section className="w-full bg-gradient-to-r from-blue-900/50 to-purple-900/50 py-16">
				<div className="max-w-4xl mx-auto text-center px-6">
					...
					<p className="text-blue-200 text-lg mb-8 max-w-2xl mx-auto">
						Get the latest company news, announcements, and insights delivered directly to your inbox. 
						Never miss an important update from Dharvix Tech Solutions.
					</p>
