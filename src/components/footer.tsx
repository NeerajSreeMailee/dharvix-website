    ...
    <footer className="bg-gradient-to-br from-[#0a2342] via-[#193b6a] to-[#1e2a78] py-14 px-10 shadow-2xl border-t-4 border-blue-700 transition-colors">
      <div className="container grid gap-12 md:grid-cols-2 lg:grid-cols-4">
        <div className="space-y-4">
          <h3 className="text-2xl font-extrabold text-blue-100 tracking-wide drop-shadow-lg">
            DharviX Tech Solutions
          </h3>
          ...
          <div className="flex space-x-4 mt-4">
            <Link
              href="#"
              className="rounded-full bg-blue-900/40 hover:bg-blue-400/30 p-2 transition text-blue-100 hover:text-blue-300 shadow"
            >
        ...
        <div className="space-y-4">
          <h3 className="text-lg font-bold text-blue-100 uppercase tracking-wide">
            Quick Links
          </h3>
          <ul className="space-y-2 text-base">
            <li>
              <Link
                href="/"
                className="transition text-blue-200 hover:text-blue-100"
              >
                Home
              </Link>
            </li>
        ...
        <div className="space-y-4">
          ...
          <address className="not-italic text-base text-blue-200 leading-relaxed">
            <p className="mb-2">
              a-hub, Andhra University North Campus,Visakhapatnam,
            ...
            <p className="mb-2">
              ...
              <a
                ...
                className="transition text-blue-100 hover:text-blue-50"
              >
                {" "}
                {/* Subtle highlight */}
                +91 90006 33061
            ...
            <p>
              Email:{" "}
              <a
                href="mailto:info@dharvixtechsolutions.com"
                className="transition text-blue-100 hover:text-blue-50"
              >
                {" "}
                {/* Subtle highlight */}
                info@dharvixtechsolutions.com
              </a>
            </p>
          </address>
        </div>
