...
// Define the Event interface to match eventsData
interface Event {
  id: number;
  image: string;
  title: string;
  date: string;
  time: string;
  category: 'Conference' | 'Workshop' | 'Summit' | 'Company Event' | 'Competition' | 'Seminar';
  location: string;
  desc: string;
...
const eventStatuses = ['All', 'Upcoming', 'Completed', 'Cancelled'] as const;

// Type categoryColors and statusColors using Record
      ...
      <section className="w-full max-w-7xl mx-auto px-6 mb-16">
        <div className="mb-12">
          ...
          <p className="text-purple-200 text-lg">
            Don&apos;t miss these highlighted events and experiences
          </p>
        </div>
          ...
          {featuredEvents.map((event) => (
            ...
            >
              <div className="relative w-full h-[280px] overflow-hidden">
                ...
                <div className="absolute top-4 right-4">
                  <span
                    ...
                    } text-white px-2 py-1 rounded text-xs backdrop-blur-sm`}
                  >
                    {event.category}
                  </span>
                </div>
              ...
              <div className="p-8">
                ...
                <p className="text-purple-200 leading-relaxed mb-6">{event.desc}</p>
                <div className="mb-6">
                  <h4 className="text-sm font-semibold text-purple-100 mb-3">
                    Event Highlights:
                  </h4>
        ...
        <div className="flex flex-col lg:flex-row gap-6 items-center justify-between">
          <div className="flex flex-col sm:flex-row gap-4">
            <div className="flex flex-wrap gap-3">
              <span className="text-purple-200 text-sm font-medium self-center">
                Category:
              </span>
                ...
                <div className="mb-4">
                  ...
                  <div className="flex flex-wrap gap-1">
                    {event.highlights.slice(0, 2).map((highlight, i) => (
                      <span
                        key={i}
                        className="bg-purple-900/50 text-purple-200 px-2 py-1 rounded text-xs"
                      >
                        {highlight}
                      </span>
                    ))}
      ...
      <section className="w-full bg-gradient-to-r from-purple-900/50 to-blue-900/50 py-16">
        <div className="max-w-4xl mx-auto text-center px-6">
          ...
          <p className="text-purple-200 text-lg mb-8 max-w-2xl mx-auto">
            Subscribe to our event notifications and be the first to know about
            upcoming workshops, conferences, and exclusive company events. Join our
