  ...
  const customers: Customer[] = [
    {
      ...
      testimonial:
        "Dharvix's embedded solutions transformed our product development cycle, reducing time-to-market by 40%.",
      featured: true,
    },
    {
      ...
      testimonial:
        "The reliability and performance of their embedded systems exceeded our expectations.",
      featured: true,
    },
    {
      ...
      testimonial:
        "Their IoT solutions helped us create a seamless customer experience across all touchpoints.",
    },
    {
      ...
      testimonial:
        "Robust embedded systems that withstand harsh construction environments while maintaining precision.",
    },
  ];
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-20">
          <div className="text-center mb-16">
            ...
            <p className="text-xl md:text-2xl text-blue-100 max-w-5xl mx-auto mb-8 leading-relaxed">
              Since our inception in 2025, we’ve been committed to building
              future-ready partnerships
              <br />
              that enable businesses to innovate faster, scale smarter, and lead
              their industries with confidence.
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-blue-200 max-w-3xl mx-auto">
              From startups to Fortune 500 companies, our embedded solutions
              power innovation across industries
            </p>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {customers
                ...
                .map((customer, index) => (
                  <div
                    key={index}
                    className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm rounded-3xl p-8 border border-white/20 hover:border-blue-400/50 transition-all duration-300 group hover:scale-105"
                  >
          ...
          <div className="text-center mt-20">
            <div className="bg-gradient-to-r from-blue-600/20 to-purple-600/20 backdrop-blur-sm rounded-3xl p-12 border border-white/20">
              ...
              <p className="text-xl text-blue-200 mb-8 max-w-2xl mx-auto">
                ...
                the difference our embedded solutions can make for your
                business.
              </p>
